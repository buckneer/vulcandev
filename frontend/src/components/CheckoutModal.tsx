...
export default function CheckoutModal({item, show, closeModal} :
    ...
    useEffect(() => {
        ...
        if(success) {
            ...
            buyItem({username: username, itemName: item.name, itemNumber: item.itemNumber}).then(response => {
            ...
            <PayPalScriptProvider options={initialOptions}>
                <ModalDialog>
                    ...
                    <ModalBody>
                        ...
                        <p>After your payment you will be redirected to our forums which contains instructions on how to claim
                            your item</p>
                        <br />
                        <div className="input-holder w-75">
                            <input className="me-5 my-2" type="text" placeholder="Enter your username"
                                   ...
                                   value={username}/>
                            <input className="me-5 my-2" type="text" placeholder="Confirm your username"
